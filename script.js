let selecionarSP = document.querySelector('#sao-paulo');
let selecionarLV = document.querySelector('#las-vegas');
let selecionarMC = document.querySelector('#moscou');

selecionarSP.addEventListener("click", incluirDados);
selecionarLV.addEventListener("click", incluirDados);
selecionarMC.addEventListener("click", incluirDados);

function incluirDados(){

    console.log("ta pegando mano");
};
...
console.log(pontosTuriscosDowntown)